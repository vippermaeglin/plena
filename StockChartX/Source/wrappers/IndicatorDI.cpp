// IndicatorDI.cpp: implementation of the CIndicatorDI class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorDI::CIndicatorDI(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
...
CIndicatorDI::~CIndicatorDI()
{
	CIndicator::OnDestroy();
}

void CIndicatorDI::SetParamInfo(){
...
//	End Of Revision
	...
	CSeries* pDIMINUS = EnsureSeries(szName + " DI-");
	pDIMINUS->szTitle = "DI-" + CString("("+paramInt[1]+")");
