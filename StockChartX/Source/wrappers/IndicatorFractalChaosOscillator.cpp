// IndicatorFractalChaosOscillator.cpp: implementation of the CIndicatorFractalChaosOscillator class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorFractalChaosOscillator::CIndicatorFractalChaosOscillator(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indFractalChaosOscillator;

}

CIndicatorFractalChaosOscillator::~CIndicatorFractalChaosOscillator()
{
	CIndicator::OnDestroy();
}


void CIndicatorFractalChaosOscillator::SetParamInfo(){
...
BOOL CIndicatorFractalChaosOscillator::Calculate()
{
...
//	End Of Revision
	...
	COscillator ta;
	pInd = ta.FractalChaosOscillator(pNav, pRS, paramInt[1], szName);
	szTitle = "FCO" + CString("("+paramInt[1]+")");
