// IndicatorTriangularMovingAverage.cpp: implementation of the CIndicatorTriangularMovingAverage class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorTriangularMovingAverage::CIndicatorTriangularMovingAverage(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indTriangularMovingAverage;

}

CIndicatorTriangularMovingAverage::~CIndicatorTriangularMovingAverage()
{
	CIndicator::OnDestroy();
}

void CIndicatorTriangularMovingAverage::SetParamInfo(){
...
BOOL CIndicatorTriangularMovingAverage::Calculate()
{
...
//	End Of Revision
	...
	CMovingAverage ta;
	pInd = ta.TriangularMovingAverage(pNav, pSource, paramInt[1], szName);
