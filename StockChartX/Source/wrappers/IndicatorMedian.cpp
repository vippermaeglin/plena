// IndicatorMedian.cpp: implementation of the CIndicatorMedian class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorMedian::CIndicatorMedian(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indMedian;

}

CIndicatorMedian::~CIndicatorMedian()
{
	CIndicator::OnDestroy();
}


void CIndicatorMedian::SetParamInfo(){
...
BOOL CIndicatorMedian::Calculate()
{
...
//	End Of Revision
	...
	CGeneral ta;
	pInd = ta.MedianPrice(pNav, pRS, szName);
