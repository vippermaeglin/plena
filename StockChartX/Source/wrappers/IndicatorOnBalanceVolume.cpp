// IndicatorOnBalanceVolume.cpp: implementation of the CIndicatorOnBalanceVolume class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorOnBalanceVolume::CIndicatorOnBalanceVolume(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indOnBalanceVolume;

}

CIndicatorOnBalanceVolume::~CIndicatorOnBalanceVolume()
{
	CIndicator::OnDestroy();
}

void CIndicatorOnBalanceVolume::SetParamInfo(){
...
BOOL CIndicatorOnBalanceVolume::Calculate()
{
...
//	End Of Revision
	...
	CIndex ta;
	pInd = ta.OnBalanceVolume(pNav, pSource, pVolume, szName);
