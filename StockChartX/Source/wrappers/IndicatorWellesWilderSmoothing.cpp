// IndicatorWellesWilderSmoothing.cpp: implementation of the CIndicatorWellesWilderSmoothing class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorWellesWilderSmoothing::CIndicatorWellesWilderSmoothing(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indWellesWilderSmoothing;

}

CIndicatorWellesWilderSmoothing::~CIndicatorWellesWilderSmoothing()
{
	CIndicator::OnDestroy();
}

void CIndicatorWellesWilderSmoothing::SetParamInfo(){
...
BOOL CIndicatorWellesWilderSmoothing::Calculate()
{
...
//	End Of Revision
	...
	CMovingAverage ta;
	pInd = ta.WellesWilderSmoothing(pSource, paramInt[1], szName);

	if(pCtrl->m_Language==1){
		szTitle = "AWW" + CString("("+paramInt[1]+")");
	}
	else{
		szTitle = "WWS" + CString("("+paramInt[1]+")");
	}
