// IndicatorSwingIndex.cpp: implementation of the CIndicatorSwingIndex class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorSwingIndex::CIndicatorSwingIndex(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indSwingIndex;

}

CIndicatorSwingIndex::~CIndicatorSwingIndex()
{
	CIndicator::OnDestroy();
}


void CIndicatorSwingIndex::SetParamInfo(){
...
BOOL CIndicatorSwingIndex::Calculate()
{
...
//	End Of Revision
	...
	CIndex ta;
	pInd = ta.SwingIndex(pNav, pRS, paramDbl[1], szName);
