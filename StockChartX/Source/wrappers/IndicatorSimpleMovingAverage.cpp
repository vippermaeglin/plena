// IndicatorSimpleMovingAverage.cpp: implementation of the CIndicatorSimpleMovingAverage class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorSimpleMovingAverage::CIndicatorSimpleMovingAverage(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indSimpleMovingAverage;

}

CIndicatorSimpleMovingAverage::~CIndicatorSimpleMovingAverage()
{
	CIndicator::OnDestroy();
}


void CIndicatorSimpleMovingAverage::SetParamInfo(){
...
BOOL CIndicatorSimpleMovingAverage::Calculate()
{
...
//	End Of Revision
	...
	CMovingAverage ta;
	pInd = ta.SimpleMovingAverage(pNav, pSource, paramInt[1], szName);
	...
	if(pCtrl->m_Language==1){
		szTitle = "MMS"+ CString ("("+paramInt[1]+")");
	}
	else{
		szTitle = "SMA" +CString("("+paramInt[1]+")");
	}
