// IndicatorDetrendedPriceOscillator.cpp: implementation of the CIndicatorDetrendedPriceOscillator class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorDetrendedPriceOscillator::CIndicatorDetrendedPriceOscillator(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indDetrendedPriceOscillator;

}

CIndicatorDetrendedPriceOscillator::~CIndicatorDetrendedPriceOscillator()
{
	CIndicator::OnDestroy();
}


void CIndicatorDetrendedPriceOscillator::SetParamInfo(){
...
BOOL CIndicatorDetrendedPriceOscillator::Calculate()
{
...
//	End Of Revision
	...
	COscillator ta;
	pInd = ta.DetrendedPriceOscillator(pNav, pSource, paramInt[1], paramInt[2], szName);
	szTitle = "DPO" + CString("("+paramInt[1]+")");
