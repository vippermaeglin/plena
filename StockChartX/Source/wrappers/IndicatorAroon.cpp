// IndicatorAroonOscillator.cpp: implementation of the CIndicatorAroonOscillator class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorAroonOscillator::CIndicatorAroonOscillator(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indAroonOscillator;

}

CIndicatorAroonOscillator::~CIndicatorAroonOscillator()
{
	CIndicator::OnDestroy();
}


void CIndicatorAroonOscillator::SetParamInfo(){
...
BOOL CIndicatorAroonOscillator::Calculate()
{
...
//	End Of Revision
	...
	for(int n = 0; n < size; ++n){
		if(n < paramInt[1]){			
			...
			value = pInd->getValue("Aroon Oscillator", n + 1);						
		}
