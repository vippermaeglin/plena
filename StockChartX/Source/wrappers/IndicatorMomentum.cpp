// IndicatorMomentum.cpp: implementation of the CIndicatorMomentum class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorMomentum::CIndicatorMomentum(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indMomentumOscillator;

}

CIndicatorMomentum::~CIndicatorMomentum()
{
	CIndicator::OnDestroy();
}


void CIndicatorMomentum::SetParamInfo(){
...
BOOL CIndicatorMomentum::Calculate()
{
...
//	End of Revision
	...
	COscillator ta;
	pInd = ta.Momentum(pNav, pSource, paramInt[1], szName);
	szTitle = "MO" + CString("("+paramInt[1]+")");
