// IndicatorLinearRegressionSlope.cpp: implementation of the CIndicatorLinearRegressionSlope class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorLinearRegressionSlope::CIndicatorLinearRegressionSlope(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indLinearRegressionSlope;

}

CIndicatorLinearRegressionSlope::~CIndicatorLinearRegressionSlope()
{
	CIndicator::OnDestroy();
}

void CIndicatorLinearRegressionSlope::SetParamInfo(){
...
BOOL CIndicatorLinearRegressionSlope::Calculate()
{
...
//	End Of Revision
	...
	if(pCtrl->m_Language==1){
		szTitle = "IRL" + CString("("+paramInt[1]+")");
	}
	else{
		szTitle = "LRS" + CString("("+paramInt[1]+")");
	}
