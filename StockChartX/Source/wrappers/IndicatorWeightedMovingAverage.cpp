// IndicatorWeightedMovingAverage.cpp: implementation of the CIndicatorWeightedMovingAverage class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorWeightedMovingAverage::CIndicatorWeightedMovingAverage(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indWeightedMovingAverage;

}

CIndicatorWeightedMovingAverage::~CIndicatorWeightedMovingAverage()
{
	CIndicator::OnDestroy();
}

void CIndicatorWeightedMovingAverage::SetParamInfo(){
...
BOOL CIndicatorWeightedMovingAverage::Calculate()
{
...
//	End Of Revision
	...
	CMovingAverage ta;
	pInd = ta.WeightedMovingAverage(pNav, pSource, paramInt[1], szName);
