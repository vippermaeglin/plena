// IndicatorPositiveVolumeIndex.cpp: implementation of the CIndicatorPositiveVolumeIndex class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorPositiveVolumeIndex::CIndicatorPositiveVolumeIndex(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indPositiveVolumeIndex;

}

CIndicatorPositiveVolumeIndex::~CIndicatorPositiveVolumeIndex()
{
	CIndicator::OnDestroy();
}

void CIndicatorPositiveVolumeIndex::SetParamInfo(){
...
BOOL CIndicatorPositiveVolumeIndex::Calculate()
{
...
//	End Of Revision
	...
	CIndex ta;
	pInd = ta.PositiveVolumeIndex(pNav, pSource, pVolume, szName);
