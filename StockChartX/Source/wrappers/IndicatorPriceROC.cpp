// IndicatorPriceROC.cpp: implementation of the CIndicatorPriceROC class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorPriceROC::CIndicatorPriceROC(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indPriceROC;

}

CIndicatorPriceROC::~CIndicatorPriceROC()
{
	CIndicator::OnDestroy();
}

void CIndicatorPriceROC::SetParamInfo(){
	...
	*/
	...
	SetParam(0, ptSource, "");
	SetParam(1, ptPeriods, "12");

}

BOOL CIndicatorPriceROC::Calculate()
{
...
//	End Of Revision
	...
	CGeneral ta;
	pInd = ta.PriceROC(pNav, pSource, paramInt[1], szName);
	szTitle = "PROC" + CString("("+paramInt[1]+")");
