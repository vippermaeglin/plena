// IndicatorExponentialMovingAverage.cpp: implementation of the CIndicatorExponentialMovingAverage class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorExponentialMovingAverage::CIndicatorExponentialMovingAverage(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indExponentialMovingAverage;

}

CIndicatorExponentialMovingAverage::~CIndicatorExponentialMovingAverage()
{
	CIndicator::OnDestroy();
}


void CIndicatorExponentialMovingAverage::SetParamInfo(){
...
BOOL CIndicatorExponentialMovingAverage::Calculate()
{
...
//	End of Revision
	...
	CMovingAverage ta;
	pInd = ta.ExponentialMovingAverage(pNav, pSource, paramInt[1], szName);
	if(pCtrl->m_Language==1){
		szTitle = "EMM"+ CString ("("+paramInt[1]+")");
	}
	else{
		szTitle = "EMA" +CString("("+paramInt[1]+")");
	}	
