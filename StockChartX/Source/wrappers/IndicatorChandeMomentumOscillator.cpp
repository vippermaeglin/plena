// IndicatorChandeMomentumOscillator.cpp: implementation of the CIndicatorChandeMomentumOscillator class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorChandeMomentumOscillator::CIndicatorChandeMomentumOscillator(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indChandeMomentumOscillator;

}

CIndicatorChandeMomentumOscillator::~CIndicatorChandeMomentumOscillator()
{
	CIndicator::OnDestroy();
}

void CIndicatorChandeMomentumOscillator::SetParamInfo()
{
...
BOOL CIndicatorChandeMomentumOscillator::Calculate()
{
...
//	End Of Revision
	...
	COscillator ta;
	pInd = ta.ChandeMomentumOscillator(pNav, pSource, paramInt[1], szName);
	szTitle = "CMO"+ CString ("("+paramInt[1]+")");
