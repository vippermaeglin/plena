// IndicatorTrueRange.cpp: implementation of the CIndicatorTrueRange class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorTrueRange::CIndicatorTrueRange(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indTrueRange;

}

CIndicatorTrueRange::~CIndicatorTrueRange()
{
	CIndicator::OnDestroy();
}


void CIndicatorTrueRange::SetParamInfo(){
...
BOOL CIndicatorTrueRange::Calculate()
{
...
//	End Of Revision
	...
	COscillator ta;
	pInd = ta.TrueRange(pNav, pRS, szName);
