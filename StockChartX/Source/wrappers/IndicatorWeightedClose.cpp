// IndicatorWeightedClose.cpp: implementation of the CIndicatorWeightedClose class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorWeightedClose::CIndicatorWeightedClose(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indWeightedClose;

}

CIndicatorWeightedClose::~CIndicatorWeightedClose()
{
	CIndicator::OnDestroy();
}


void CIndicatorWeightedClose::SetParamInfo(){
...
BOOL CIndicatorWeightedClose::Calculate()
{
...
//	End Of Revision
	...
	CGeneral ta;
	pInd = ta.WeightedClose(pNav, pRS, szName);
