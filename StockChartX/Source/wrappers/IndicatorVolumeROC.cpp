// IndicatorVolumeROC.cpp: implementation of the CIndicatorVolumeROC class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorVolumeROC::CIndicatorVolumeROC(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indVolumeROC;

}

CIndicatorVolumeROC::~CIndicatorVolumeROC()
{
	CIndicator::OnDestroy();
}


void CIndicatorVolumeROC::SetParamInfo(){
...
BOOL CIndicatorVolumeROC::Calculate()
{
...
//	End Of Revision
	...
	CGeneral ta;
	pInd = ta. VolumeROC(pNav, pVolume, paramInt[1], szName);
	
	szTitle = "VROC" + CString ("("+paramInt[1]+")");
