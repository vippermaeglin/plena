// IndicatorLinearRegressionRSquared.cpp: implementation of the CIndicatorLinearRegressionRSquared class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorLinearRegressionRSquared::CIndicatorLinearRegressionRSquared(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indLinearRegressionRSquared;

}

CIndicatorLinearRegressionRSquared::~CIndicatorLinearRegressionRSquared()
{
	CIndicator::OnDestroy();
}


void CIndicatorLinearRegressionRSquared::SetParamInfo(){
...
BOOL CIndicatorLinearRegressionRSquared::Calculate()
{
...
//	End of Revision
	...
	if(pCtrl->m_Language==1){
		szTitle = "RLRR" + CString("("+paramInt[1]+")");
	}
	else{
		szTitle = "LRRS" + CString("("+paramInt[1]+")");
	}
	...
	for(int n = 0; n < size; ++n){
		if(n < paramInt[1]){
			...
			value = pInd->getValue("RSquared", n + 1);
		}
