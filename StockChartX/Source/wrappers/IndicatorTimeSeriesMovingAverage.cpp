// IndicatorTimeSeriesMovingAverage.cpp: implementation of the CIndicatorTimeSeriesMovingAverage class.
//
//////////////////////////////////////////////////////////////////////
...
CIndicatorTimeSeriesMovingAverage::CIndicatorTimeSeriesMovingAverage(LPCTSTR name, int type, int members, CChartPanel* owner)
{
	szName = name;
	ownerPanel = owner;
	pCtrl = owner->pCtrl;
	...
	indicatorType = indTimeSeriesMovingAverage;

}

CIndicatorTimeSeriesMovingAverage::~CIndicatorTimeSeriesMovingAverage()
{
	CIndicator::OnDestroy();
}


void CIndicatorTimeSeriesMovingAverage::SetParamInfo(){
...
BOOL CIndicatorTimeSeriesMovingAverage::Calculate()
{
...
//	End Of Revision
	...
	CMovingAverage ta;
	pInd = ta.TimeSeriesMovingAverage(pNav, pSource, paramInt[1], szName);
