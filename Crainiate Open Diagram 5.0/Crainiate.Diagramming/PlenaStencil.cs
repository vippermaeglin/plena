...
{
	public class PlenaStencil: Stencil
	{
		#region Interface
        ...
        /*private void DrawStencilItem(StencilItem stencil, DrawShapeEventArgs e)
		{
			...
			else if (stencil.Key == "Statement")
			{
				path.AddRectangle(rect);
			}
			else if (stencil.Key == "Connector")
			{
		...
		private void DrawStencilItem(StencilItem stencil, DrawShapeEventArgs e)
		{
            ...
            else if (stencilType == BasicStencilType.RoundedRectangle || stencilType == BasicStencilType._OU_ || stencilType == BasicStencilType.REGRA || stencilType == BasicStencilType._E_)
			{
            ...
            else if (stencilType == BasicStencilType.CONECTOR)
            {
                percX = Convert.ToSingle(width * 0.5);
