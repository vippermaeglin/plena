...
namespace M4
{
  public partial class frmScannerMainSettings : Form
  {
    ...
    public frmScannerMainSettings(ctlScanner owner)
    {
      ...
      m_scanner = owner;
      //Palette = frmMain2.NevronPalette;
    }
    ...
    private bool VerifyForm()
    {
      ...
      {
        case "Minute":
          m_scanner.Periodicity = (int)M4Core.Entities.Periodicity.Minutely;
          break;
        case "Hour":
          m_scanner.Periodicity = (int)M4Core.Entities.Periodicity.Hourly;
          break;
        case "Day":
          m_scanner.Periodicity = (int)M4Core.Entities.Periodicity.Daily;
          break;
        case "Week":
          m_scanner.Periodicity = (int)M4Core.Entities.Periodicity.Weekly;
          break;
      }
