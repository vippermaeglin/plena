...
{
	public partial class DiaryEditor : RadRibbonForm
	{
	    ...
	    private string path;
	    public TradeDiaryView ParentControl;

		public DiaryEditor(string URL, TradeDiaryView PARENT)
		{
		    path = URL;
        ...
        public DiaryEditor(bool singleInstance)
		{
        ...
        */
		...
		{   
			...
			if (sender == BtnSaveAsHTML)
			{
				format = "html";
			}
			else if (sender == BtnSaveAsPDF)
			{
				format = "pdf";
			}
			else if (sender == BtnSaveAsPLAIN)
			{
				format = "txt";
			}
			else if (sender == BtnSaveAsWORD)
			{
				format = "docx";
			}
			else if (sender == BtnSaveAsXAML)
			{
				format = "xaml";
			}
			else if (sender == BtnSaveAsRTF)
			{
				format = "rtf";
			}
