namespace M4
{
  partial class ctlScanner
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.ProgressBar1 = new Nevron.UI.WinForm.Controls.NProgressBar();
      this.lblSymbol = new System.Windows.Forms.Label();
      this.cboScanners = new Nevron.UI.WinForm.Controls.NComboBox();
      this.lblAlert = new System.Windows.Forms.Label();
      this.m_ImgList = new System.Windows.Forms.ImageList(this.components);
      this.cmdEditScript = new Nevron.UI.WinForm.Controls.NButton();
      this.tmrUpdate = new System.Windows.Forms.Timer(this.components);
      this.cmdSave = new Nevron.UI.WinForm.Controls.NButton();
      this.grpSaveLoadScanner = new Nevron.UI.WinForm.Controls.NGrouper();
      this.txtScannerName = new Nevron.UI.WinForm.Controls.NTextBox();
      this.Label1 = new System.Windows.Forms.Label();
      this.cmdScanner = new Nevron.UI.WinForm.Controls.NButton();
      this.grdResults = new M4DataGridView();
      this.pnlProgress.SuspendLayout();
      ((System.ComponentModel.ISupportInitialize)(this.grpSaveLoadScanner)).BeginInit();
      ...
      // cboScanners
      // 
      this.cboScanners.ListProperties.ColumnOnLeft = false;
      this.cboScanners.Location = new System.Drawing.Point(94, 72);
      this.cboScanners.Name = "cboScanners";
      this.cboScanners.Palette.Scheme = Nevron.UI.WinForm.Controls.ColorScheme.Standard;
      ...
      this.cmdEditScript.Palette.Scheme = Nevron.UI.WinForm.Controls.ColorScheme.Standard;
      ...
      this.grpSaveLoadScanner.FooterItem.ContentAlign = System.Drawing.ContentAlignment.MiddleRight;
      this.grpSaveLoadScanner.FooterItem.Text = "Footer";
      this.grpSaveLoadScanner.FooterItem.Visible = false;
      this.grpSaveLoadScanner.HeaderItem.Text = "Scanner Settings";
      this.grpSaveLoadScanner.Location = new System.Drawing.Point(9, 9);
      this.grpSaveLoadScanner.Name = "grpSaveLoadScanner";
      this.grpSaveLoadScanner.Palette.Scheme = Nevron.UI.WinForm.Controls.ColorScheme.Standard;
      ...
      this.txtScannerName.Palette.Scheme = Nevron.UI.WinForm.Controls.ColorScheme.Standard;
      ...
      // cmdScanner
      // 
      this.cmdScanner.Border.BaseColor = System.Drawing.Color.LimeGreen;
      this.cmdScanner.Border.Style = Nevron.UI.BorderStyle3D.Flat;
      this.cmdScanner.Location = new System.Drawing.Point(390, 47);
      this.cmdScanner.Name = "cmdScanner";
      this.cmdScanner.Palette.Scheme = Nevron.UI.WinForm.Controls.ColorScheme.Standard;
      ...
      ((System.ComponentModel.ISupportInitialize)(this.grpSaveLoadScanner)).EndInit();
    ...
    internal Nevron.UI.WinForm.Controls.NProgressBar ProgressBar1;
    internal System.Windows.Forms.Label lblSymbol;
    internal Nevron.UI.WinForm.Controls.NComboBox cboScanners;
    internal System.Windows.Forms.Label lblAlert;
    internal System.Windows.Forms.ImageList m_ImgList;
    internal Nevron.UI.WinForm.Controls.NButton cmdEditScript;
    internal System.Windows.Forms.Timer tmrUpdate;
    internal Nevron.UI.WinForm.Controls.NButton cmdSave;
    internal Nevron.UI.WinForm.Controls.NGrouper grpSaveLoadScanner;
    internal Nevron.UI.WinForm.Controls.NTextBox txtScannerName;
    internal System.Windows.Forms.Label Label1;
    internal Nevron.UI.WinForm.Controls.NButton cmdScanner;
