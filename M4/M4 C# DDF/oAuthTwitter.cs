  ...
  public class oAuthTwitter : OAuthBase
  {
    ...
    public string ConsumerKey
    {
      get
      {
        ...
        {
          _consumerKey = oAuthTwitterExample.Properties.Settings.Default.consumerKey;
        }
        return _consumerKey;
      }
    ...
    public string ConsumerSecret
    {
      get
      {
        ...
        {
          _consumerSecret = oAuthTwitterExample.Properties.Settings.Default.consumerSecret;
        }
